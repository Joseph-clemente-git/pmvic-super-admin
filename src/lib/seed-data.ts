...
export function seedUsers(): AppUser[] {
  return [
    ...
    },
    {
      id: "user-branch-1",
      name: "Jonalyn Ramos",
      email: "jonalyn.ramos@staclara-pmvic.ph",
      role: "branch_admin",
      orgId: ORG_IDS.norte,
      branchId: "br-2",
      status: "active",
      avatarColor: "bg-chart-4",
      invitedAt: daysAgo(280),
      lastLoginAt: daysAgo(5, 11, 0),
    },
    {
      id: "user-org-4",
      name: "Liza Fernandez",
  ...
  return [
    {
      ...
      description: "Bulacan Main (Bulacan Testing Center Inc.) has an outstanding balance of ₱8,200.00.",
